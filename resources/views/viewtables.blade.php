...
<body class="bg-green">
    <div class="container mt-5">
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <form action="{{ route('loans.index') }}" method="POST" class="bg-white p-4 rounded shadow-sm"
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" step="0.01" class="form-control" id="outstanding_balance"
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <form action="{{ route('payments.index') }}" method="POST" class="bg-white p-4 rounded shadow-sm"
                    enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3">
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <form action="{{ route('loan-types.index') }}" method="POST" class="bg-white p-4 rounded shadow-sm"
                    enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3">
                        <label for="loan_type_name" class="form-label">Loan Type Name</label>
                        <input type="text" class="form-control" id="loan_type_name" name="loan_type_name"
                            required>
                    </div>
                    <div class="mb-3">
                    ...
                    <tbody>
                        @foreach ($Loan as $loan)
                            <tr>
                                ...
                                <td><img src="{{ asset('storage/' . $loan->image_path) }}" alt="Loan Image"
                                        width="100"></td>
                            </tr>
                        @endforeach
                    </tbody>
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <form class="d-flex justify-content-between" action="{{ route('view.loan') }}" method="GET">
                    <div class="col-auto flex-grow-1 me-2">
                        <input class="form-control" type="search" placeholder="Search..."
                            value="{{ request('search_payment') }}" name="search_payment">
                    </div>
                    <button type="submit" class="btn btn-green">Search</button>
                </form>
            </div>
                    ...
                    <tbody>
                        @foreach ($Payment as $payment)
                            <tr>
                                ...
                                <td><img src="{{ asset('storage/' . $payment->image_path) }}" alt="Payment Image"
                                        width="100"></td>
                            </tr>
                        @endforeach
                    </tbody>
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <form class="d-flex justify-content-between" action="{{ route('view.loan') }}" method="GET">
                    <div class="col-auto flex-grow-1 me-2">
                        <input class="form-control" type="search" placeholder="Search..."
                            value="{{ request('search_loan_type') }}" name="search_loan_type">
                    </div>
                    <button type="submit" class="btn btn-green">Search</button>
                </form>
            </div>
                    ...
                    <tbody>
                        @foreach ($LoanType as $loanType)
                            <tr>
                                ...
                                <td><img src="{{ asset('storage/' . $loanType->image_path) }}" alt="Loan Type Image"
                                        width="100"></td>
                            </tr>
                        @endforeach
                    </tbody>
